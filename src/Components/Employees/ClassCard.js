...
//   console.log(props)  const [classToEdit, setClassToEdit] = useState(props)
//   const token = localStorage.getItem('token')
//   const {authCode} = jwt_decode(token)  // const editClass = () => {
  //   setEditing(true)
  //   axiosWithAuth()
  ...
  //     });
  // };  // const saveEdit = e => {
  //   e.preventDefault();  //   axiosWithAuth()
  //   .put(`/classes/${classToEdit.id}`, classToEdit)
  //     .then(() => { window.location.reload() })
  //     .catch(err => console.log(err))
  //   setEditing(false)  // }  const deleteClass = (id) => {
